 ...
 * @author Paco
 */
@WebServlet(name = "HacerOperacion", urlPatterns = {"/HacerOperacion"})
public class HacerOperacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int opeI = Integer.parseInt(ope);
            bancoEJB.hacerOperacion(dni, opeI, op);

            out.println("Se ha hecho la operación correctamente");
