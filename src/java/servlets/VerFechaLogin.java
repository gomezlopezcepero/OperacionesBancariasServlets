 ...
 * @author Paco
 */
@WebServlet(name = "VerFechaLogin", urlPatterns = {"/VerFechaLogin"})
public class VerFechaLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          Historial l = bancoEJB.verFechaLogin(fecha);

            out.println("Mi último inicio de sesión fue el: "+l.getFechaHora()+" <br>");
